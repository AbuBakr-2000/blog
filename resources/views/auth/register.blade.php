                        ...
                        <form action="{{ route('register.store') }}" method="POST">
                            ...
                            <div class="form-group py-2">
                                <div class="input-field"> <span class="far fa-user p-2"></span>
                                    <input type="text" class="form-control p-4 @error('name') is-invalid @enderror" name="name" placeholder="Username" required>
                                    @error('name')
                            ...
                            <div class="form-group py-2">
                                <div class="input-field"> <span class="far fa-user p-2"></span>
                                    <input class="form-control p-4 @error('email') is-invalid @enderror" type="email" name="email" placeholder="Email">
                                    @error('email')
                                    <p class="help-block text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group py-1 pb-2">
                                <div class="input-field"> <span class="fas fa-lock px-2"></span>
                                    <input class="form-control p-4 @error('password') is-invalid @enderror" type="password" name="password" placeholder="Enter your Password" required>
                                    @error('password')
                                    <p class="help-block text-danger">{{ $message }}</p>
                                @enderror
                                    <a class="btn bg-white text-muted"> <span class="far fa-eye-slash"></span></a>
                                </div>
                            </div>
                            <div class="form-group py-1 pb-2">
                                <div class="input-field"> <span class="fas fa-lock px-2"></span>
                                    <input class="form-control p-4 @error('password_confirmation') is-invalid @enderror" type="password" name="password_confirmation" placeholder="Password Confirm" required>
